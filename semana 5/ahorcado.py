''' Juego de ahorcado donde se debe adivinar un nombre de ciudad en México, cuenta con
6 oportunidades de error, utiliza solo letras minúsculas y sin acentos 
'''

# Se importa la librería random
import random

# Se importa el paquete que contiene las palabras y los monitos
